...
def get_vectorstore_from_url(url):
    ...
    vector_store = Chroma.from_documents(document_chunks, GoogleGenerativeAIEmbeddings(model="models/text-embedding-004", google_api_key="AIzaSyB68nFWXicYbeGGAj7Lca90HvARW_1_wVQ"))
